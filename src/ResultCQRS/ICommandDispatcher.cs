...
public interface ICommandDispatcher
{
    ...
    /// <typeparam name="TCommandResult">Type of the result.</typeparam>
    /// <returns>The result of the operation.</returns>
    Task<Result<TCommandResult>> DispatchAsync<TCommand, TCommandResult>(TCommand command, IServiceProvider scopeToUse, CancellationToken cancellation = default) where TCommand : ICommand<TCommandResult>;
    ...
    /// <typeparam name="TCommand">Type of the command.</typeparam>
    /// <returns>The result of the operation.</returns>
    Task<Result> DispatchAsync<TCommand>(TCommand command, IServiceProvider scopeToUse, CancellationToken cancellation = default) where TCommand : ICommand;
}
