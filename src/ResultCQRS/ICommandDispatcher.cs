...
public interface ICommandDispatcher
{
    ...
    /// <typeparam name="TCommandResult">Type of the result.</typeparam>
    /// <returns>The result of the operation.</returns>
    Task<Result<TCommandResult>> DispatchAsync<TCommand, TCommandResult>(TCommand command, IServiceProvider scope, CancellationToken cancellation = default) where TCommand : ICommand;
